...
public class HSFGenerateUtils {
    ...
    public HSFGenerateUtils() {
    }

    public HSFGenerateUtils(String author, String jdbcUrl, String jdbcName, String jdbcPwd, String jdbcDriver,
