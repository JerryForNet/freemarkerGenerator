...
@Data
@Slf4j
public class SpringColudGenerateUtils {
    ...
    public SpringColudGenerateUtils() {
    }

    public SpringColudGenerateUtils(String author, String jdbcUrl, String jdbcName, String jdbcPwd, String jdbcDriver,
     ...
     * @throws Exception
     */
    public boolean generateMS(String prefix, String tableName, String tableAnnotation, TemplateTypeEnum templateType) throws Exception {
        ResultSet resultSet = null;

        try {
            boolean isOverwrite = true;
            boolean isUseLombok = true;
            ...
            //生成Mapper文件
            generateFile(prefix, tableName, tableAnnotation, isUseLombok, isOverwrite, "mapper", "Mapper.xml", templateType.getPath() + "MapperXML.ftl", columnClassList);

            //生成服务层接口文件
            generateFile(prefix, tableName, tableAnnotation, isUseLombok, isOverwrite, "service", "Service.java", templateType.getPath() + "Service.ftl", columnClassList);

            //生成服务实现层文件
            generateFile(prefix, tableName, tableAnnotation, isUseLombok, isOverwrite, "service" + File.separator + "impl", "ServiceImpl.java", templateType.getPath() + "ServiceImpl.ftl", columnClassList);

            //生成Dao文件
            generateFile(prefix, tableName, tableAnnotation, isUseLombok, isOverwrite, "dao", "Mapper.java", templateType.getPath() + "Mapper.ftl", columnClassList);

            //生成DTO文件
            generateFile(prefix, tableName, tableAnnotation, isUseLombok, isOverwrite, "dto", "ParamDTO.java", templateType.getPath() + "ParamDTO.ftl", columnClassList);

            //生成DTO文件
            generateFile(prefix, tableName, tableAnnotation, isUseLombok, isOverwrite, "dto", "ResultDTO.java", templateType.getPath() + "ResultDTO.ftl", columnClassList);

            //生成Model文件
            generateFile(prefix, tableName, tableAnnotation, isUseLombok, isOverwrite, "entity", "Entity.java", templateType.getPath() + "Entity.ftl", columnClassList);

            //生成Repository文件
            generateFile(prefix, tableName, tableAnnotation, isUseLombok, isOverwrite, "repository", "Repository.java", templateType.getPath() + "Repository.ftl", columnClassList);

            //生成Repository实现层
            generateFile(prefix, tableName, tableAnnotation, isUseLombok, isOverwrite, "repository" + File.separator + "impl", "RepositoryImpl.java", templateType.getPath() + "RepositoryImpl.ftl", columnClassList);
     ...
     * @param prefix          前缀
     * @param tableName       表面
     * @param tableAnnotation 表注释
     * @param isUseLombok
     * @param isOverwrite     是否覆盖
     * @param subPath         前缀
     * @param suffix          模板文件名
     * @param templateName    模板目录
     * @param columnClassList 表字段
     * @throws Exception
     */
